...
define('BASE_URL', 'https://demo4.itourscloud.com/crm/');
...
{ // extending email file
  ...
  {
    global $app_email_id_send, $app_user_name_send, $app_name, $app_contact_no, $admin_logo_url, $app_website, $app_smtp_status, $app_smtp_host, $app_smtp_port, $app_smtp_password, $app_smtp_method, $emp_email_id, $emp_id, $accountant_email, $conn;
  ...
  {
    global $app_email_id_send, $app_name, $app_contact_no, $admin_logo_url, $app_website, $app_smtp_status, $app_smtp_host, $app_smtp_port, $app_smtp_password, $app_smtp_method, $emp_email_id, $emp_id, $accountant_email, $conn;
